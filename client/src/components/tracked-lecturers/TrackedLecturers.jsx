...
import LecturerDetailsModal from "../components/tracked-lecturers/LecturerDetailsModal";
...
const TrackedLecturers = () => {
  ...
  // Close lecturer details modal and reset selected lecturer
  const closeModal = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-purple-50/30 to-indigo-50/40" dir="rtl">
      ...
      {/* Modal for viewing lecturer details */}
